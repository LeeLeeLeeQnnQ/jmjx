    ...
    <Card shadow>
      <Form>
        <Row :gutter="20">
          ...
          <i-col :md="6" :lg="6">
            <FormItem label="招商经理">
              <Select v-model="sreachInfo.employee_id" clearable style="width: 200px">
...
export default {
  ...
  data () {
    return {
      ...
      // 渠道来源 
      sources_list:["58渠道","微信群","电话渠道","中介推荐","BD推荐","老用户介绍","同行推荐","品牌渠道","访客","官网","其他"],
      // 意向程度
      head_list:["已签约","高意向","一般","无意向"],
      // 队伍
      group_list:['望京组','十里堡组','通州组','四道口组'],
      // 饼状图数据
      pie_data:{
        area:[],
        category:[],
