...
// 权限
// /api/StoreLease/show,/api/StoreLease/edit,/api/Index/getWorkCategory,/api/StoreEmployee/index,/api/StoreEmployee/add,/api/StoreEmployee/edit,/api/StoreEmployee/delete,/api/StoreDevice/show,/api/StoreDevice/edit,/api/StoreLease/edit
